...
GraphicsEngine::GraphicsEngine()
{
	...
	{
		throw std::exception("Render System not created succesfully");
	}
...
void GraphicsEngine::setMaterial(const MaterialPtr& material)
{
	...
	//Set the default shader in the graphics pipeline
...
void GraphicsEngine::getVertexMeshLayoutByteCodeAndSize(void** byte_code, size_t* size)
{
